...
\begin{document}
  ...
  successive year pairs was 0.32, showing a week positive autocorrelation.
  As figure \ref{fig:plot} shows, an annual mean temperature is likely to increase 
  as that of its previous year increases. The correlation was statistically significant 
